...
@Photon
public class ArmControler_Photon {
    Telemetry telemetry;

    double rotateAngle;

    private PhotonDcMotor slider;
    private PhotonDcMotor axDown;
    private PhotonDcMotor axUp;
    private Servo wrist;
    private Servo claw;
    ...
    public ArmControler_Photon(HardwareMap hardwareMap, Telemetry telemetry){
        this.telemetry = telemetry;

        PhotonDcMotor slider = (PhotonDcMotor) hardwareMap.dcMotor.get("brat");
        PhotonDcMotor axDown = (PhotonDcMotor) hardwareMap.dcMotor.get("axDown");
        PhotonDcMotor axUp = (PhotonDcMotor) hardwareMap.dcMotor.get("axUp");
