...
@Disabled
@Autonomous (name = "HoldGateBlue")

public class HoldGateBlue extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        TrajectorySequence autonomous = drive.trajectorySequenceBuilder(startingPose)
                ...
                .resetVelConstraint()
                .splineToSplineHeading(new Pose2d(13, -62, Math.toRadians(-90)), Math.toRadians(90))
                ...
                // Spline to open gate
                .splineToSplineHeading(new Pose2d(-3, -48, Math.toRadians(0)), Math.toRadians(-90))
